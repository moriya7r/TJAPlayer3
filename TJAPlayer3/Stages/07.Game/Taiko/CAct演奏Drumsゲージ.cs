        ...
        public override int On進行描画()
        {
            if (!base.b活性化してない)
            {
                ...
                */
                ...
                {
                    //仮置き
                    int[] nSoulFire = new int[] { TJAPlayer3.Skin.Game_Gauge_Soul_Y[0] - 73, TJAPlayer3.Skin.Game_Gauge_Soul_Y[1] - 73, 0, 0 };
                ...
                {
                    //仮置き
                    int[] nSoulY = new int[] { TJAPlayer3.Skin.Game_Gauge_Soul_Y[0], TJAPlayer3.Skin.Game_Gauge_Soul_Y[1], 0, 0 };
                    for (int i = 0; i < TJAPlayer3.ConfigIni.nPlayerCount; i++)
                    {
